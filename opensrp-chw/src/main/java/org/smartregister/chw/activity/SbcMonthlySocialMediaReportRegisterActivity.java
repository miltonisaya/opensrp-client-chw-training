...
import org.smartregister.chw.fragment.SbcMonthlySocialMediaReportRegisterFragment;
import org.smartregister.chw.sbc.util.Constants;
import org.smartregister.view.fragment.BaseRegisterFragment;

public class SbcMonthlySocialMediaReportRegisterActivity extends CoreSbcRegisterActivity {

    public static void startRegistration(Activity activity, String baseEntityId) {
        Intent intent = new Intent(activity, SbcMonthlySocialMediaReportRegisterActivity.class);
    ...
    protected BaseRegisterFragment getRegisterFragment() {
        return new SbcMonthlySocialMediaReportRegisterFragment();
    }
    ...
    protected void onResumption() {
        ...
        if (menu != null) {
            menu.getNavigationAdapter().setSelectedView(CoreConstants.DrawerMenu.SBC_MONTHLY_SOCIAL_MEDIA_REPORT);
        }
    }
    ...
    protected void registerBottomNavigation() {
        ...
        bottomNavigationView.getMenu().removeItem(R.id.action_sbc_mobilization);
    }
}
