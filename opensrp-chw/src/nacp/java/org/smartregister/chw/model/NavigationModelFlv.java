...
public class NavigationModelFlv implements NavigationModel.Flavor {
    ...
    public List<NavigationOption> getNavigationItems() {
        if (navigationOptions.isEmpty()) {
            ...
            NavigationOption geNavigationOption = new NavigationOption(R.mipmap.sidemenu_families, R.mipmap.sidemenu_families_active, R.string.menu_ge, CoreConstants.DrawerMenu.GE, 0);
            ...
            navigationOptions.add(2,geNavigationOption);
        }
